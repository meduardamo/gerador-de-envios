...
from polling_extracao_core import (
    ...
    POLLING_MANUAL_TIPOS_RESULTADO,
    ...
    limitar_float,
    normalizar_inteiro_simples,
    normalizar_payload_polling,
    normalizar_percentual_resultado,
    normalizar_percentual_simples,
...
# O core de extração não importa Streamlit: a chave dos Secrets entra por aqui.
